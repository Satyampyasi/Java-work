class BankAccountdetail{
     ...
     public static void main(String[] args){
       BankAccountdetail Sbi =   new BankAccountdetail();
       BankAccountdetail canara = new BankAccountdetail();
       BankAccountdetail kotak =  new BankAccountdetail();
      ...
      System.out.println(" Contact number "+kotak.Contactno);

      System.out.println();
      System.out.println("Kodakbank user account detail");
      System.out.println(" username is "+canara.Username);
      System.out.println(" age is "+canara.age);
      System.out.println(" account number"+canara.Accountno);
      System.out.println(" bank balance "+canara.balance);
      System.out.println(" Contact number "+canara.Contactno);
